...
class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            // Note: Replace "your_database_host", "your_database_port", "your_database",
            // "your_username", and "your_password" with your actual database details.
        ...
        BufferedImage image = ImageIO.read(new File("mrcet.jpeg"));
        JLabel label = new JLabel(new ImageIcon(image));
        label.setSize(400,300);
        label.setBounds(300,200,400,300);
        home.setLayout(null);
        home.setBackground(new Color(128,128,255));
        home.add(label);
        home.add(l1);
